<div class="header">
        <div class="img-header">
            <img src="http://localhost/ssu-platform/public/img/logo_utp.png" width="90" height="90">
        </div>
                ...
                <li>
                    <div class="dropdown">
                        <button class="dropbtn">Nombre de usuario<i><img class="icon"
                                    src="http://localhost/ssu-platform/public/img/user_icon.png" width="40px" height="40px"></i><i class="fa fa-caret-down"></i></button>
